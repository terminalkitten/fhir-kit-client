...
module.exports = class {
  ...
  static getResponse(requestResponse) {
    return requestResponse.__response; // eslint-disable-line no-underscore-dangle
  }
  ...
  async request(httpVerb, url, options = {}, body) {
    ...
    const requestResponse = await request(requestParams)
      .then((response) => {
        ...
        Object.defineProperty(bodyWithResponse, '__response', {
          writable: false,
          enumerable: false,
          value: response,
        });
